...
<body>
    ...
    <div class="container">
        <h1>LISTE DE PRESENCE FORMATION AWS 1</h1>
        ...
        <table>
            ...
            <?php 
                ...
                if(mysqli_num_rows($req) == 0){
                    //s'il n'existe pas de participant dans la base de donné , alors on affiche ce message :
                    ...
                    while($row=mysqli_fetch_assoc($req)){
                        ...
                        <tr>
                            <td><?=$row['nom']?></td>
                            <td><?=$row['prenom']?></td>
                            <td><?=$row['Numero de telephone']?></td>
                            <td><?=$row['Adresse mail']?></td>
                            <!--Nous alons mettre l'id de chaque participant dans ce lien -->
